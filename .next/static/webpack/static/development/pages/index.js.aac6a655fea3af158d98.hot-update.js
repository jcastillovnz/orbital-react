...
var App = function App(props) {
  ...
  var handlePreloadImages = function handlePreloadImages() {
    var i, _imageIndex, fileName, filePath;
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function handlePreloadImages$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            for (i = 1; i <= _this.props.amount; i++) {
              _imageIndex = _this.props.paddingIndex ? _this.lpad(i, "0", 2) : i;
              fileName = _this.props.fileName.replace('{index}', _imageIndex);
              filePath = "".concat(_this.props.imagePath, "/").concat(fileName);

              _this.imageData.push(filePath);
            }
...
//# sourceMappingURL=index.js.aac6a655fea3af158d98.hot-update.js.map